var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
    ...
    if('undefined' == typeof(defaultProvince)){
        defaultProvince = cmbProvince.value
    }
    if('undefined' == typeof(defaultCity)){
        defaultCity = cmbCity.value
    }
    if('undefined' == typeof(defaultArea)){
        defaultArea = cmbArea.value
    }
    ...
    function flushCmb(cmb){
        cmb.options.length = 0;
        cmb.onchange = null;
        cmbAddOption(cmb, '', null)
    }
